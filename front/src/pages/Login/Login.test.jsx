...
describe("Login", () => {
  ...
  test("Deve mostrar uma mensagem de alerta ao login ser mal sucedido", async () => {
    ...
    mockedApi
      .onPost("/auth/login")
      .reply(400, { error: "Invalid credentials" });
  ...
  test("Deve mostrar uma mensagem de alerta ao login ser bem sucedido", async () => {
    ...
    mockedApi.onPost("/auth/login").reply(200, {
      artist: {
        ...
        token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzMWJlZjQ1MWMxZmMzNTU0Yjc0OGZiMiIsImlhdCI6MTY2NTg2ODQ4NywiZXhwIjoxNjY1OTU0ODg3fQ.7u2a1ww2zSZhHDWjQNc3GV-LqHvjHN4Ejo3IJ8y_TOU",
      },
    });
